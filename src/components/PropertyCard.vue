<template>
  <div>
    <div class="relative pb-5/6">
      <img
        class="absolute inset-0 h-full w-full object-cover rounded-lg shadow-md h-64"
    ...
    <div class="relative px-4 -mt-16">
      <div class="bg-white rounded-lg px-4 py-3 shadow-lg">
        ...
        <div class="mt-2 flex items-center text-sm text-gray-600">
          <svg v-for="i in 5" v-bind:key="i" viewBox="0 0 24 24" :class="property.rating >= i ? 'text-teal-500' : 'text-gray-400'" class="h-4 w-4 fill-current">
            <path
