<template>
  <div id="app" class="min-h-screen bg-gray-200 antialiased xl:flex xl:flex-col xl:overflow-y-hidden xl:h-screen">
    ...
    <div class="xl:flex xl:flex-1 xl:overflow-y-hidden">
      ...
      <main class="py-6 xl:flex-1 xl:overflow-x-hidden">
        <div class="px-4">
          <h3 class="text-gray-900 text-xl">Los Angleles</h3>
          <p
            class="text-gray-600"
          >Life like the stars in these luxurious Southern California estates.</p>
        </div>
        <div class="mt-6 sm:overflow-x-auto sm:overflow-y-hidden">
          <div class="px-4 sm:px-2 sm:pb-8 sm:inline-flex">
            <div
              v-for="i in 4"
              v-bind:key="i"
              :class="{ 'mt-6': i > 1 }"
              class="sm:mt-0 sm:w-80 sm:flex-shrink-0 sm:mx-2"
            >
              <div class="relative pb-5/6">
                <img
                  class="absolute inset-0 h-full object-cover rounded-lg shadow-md h-64"
              ...
              <div class="relative px-4 -mt-16">
                <div class="bg-white rounded-lg px-4 py-3 shadow-lg">
                  ...
                  <div class="mt-2 flex items-center text-sm text-gray-600">
                    <svg viewBox="0 0 24 24" class="h-4 w-4 fill-current text-teal-500">
                      <path
